...
function PayTcForm() {
  ...
  return (
    <>
    <div className="pb-20">
      <div className="flex gap-8 justify-center items-center w-full rounded-md h-16 absolute top-44  bg-white shadow-xl">
        <button
          onClick={() => setType('reverso')}
          href="#"
          className="bg-gray-200 hover:bg-yellow-300 h-10 w-24 rounded-md"
          >
          Reverso
        </button>
        <button className="bg-gray-200 hover:bg-green-300 h-10 w-24 rounded-md cursor-pointer"
